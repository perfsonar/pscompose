    ...
    json_schema = {
        ...
        "properties": {
            "duration": {
                ...
                "pattern": "^P(?:\\d+(?:\\.\\d+)?W)?(?:\\d+(?:\\.\\d+)?D)?(?:T(?:\\d+(?:\\.\\d+)?H)?(?:\\d+(?:\\.\\d+)?M)?(?:\\d+(?:\\.\\d+)?S)?)?$",  # noqa: E501
                "type": "string",
            ...
            "parting-comment": {"type": "string"},
            "schema": {"enum": [2], "type": "integer"},
            "starting-comment": {"type": "string"},
        },
        "required": ["duration"],
        "type": "object",
    }

    payload = {"ui_schema": {}, "json_schema": json_schema, "form_data": {}}
