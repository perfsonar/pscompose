        ...
        this.innerHTML = `
            ...
            <div class="input-container">
                ...
                <div class="input-field-container">
                    <input type="${this.eyeOff ? "password" : "text"}" id="myInput" placeholder="${
                        this.placeholder || ""
                    }" />
                    <i class="icon icon-eye" style="width: 24px;  height: 24px; color: white;" data-lucide="${
                        this.eyeOff ? "eye-off" : "eye"
                    }"></i>
